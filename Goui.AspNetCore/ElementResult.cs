    ...
    public class ElementResult : ActionResult
    {
        ...
        public override async Task ExecuteResultAsync (ActionContext context)
        {
            ...
            if (element.WantsFullScreen) {
                element.Style.Width = GetCookieDouble (context.HttpContext.Request.Cookies, "GouiWindowWidth", 32, 640, 10000);
                element.Style.Height = GetCookieDouble (context.HttpContext.Request.Cookies, "GouiWindowHeight", 24, 480, 10000);
            }
