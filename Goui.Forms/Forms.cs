...
namespace Xamarin.Forms
{
    public static class Forms
    {
        ...
        public static void Init ()
        {
            ...
            Device.PlatformServices = new GouiPlatformServices ();
            Device.Info = new GouiDeviceInfo ();
        ...
        public static void SendViewInitialized (this VisualElement self, Goui.Html.Element nativeView)
        {
            ViewInitialized?.Invoke (self, new ViewInitializedEventArgs { View = self, NativeView = nativeView });
        }

        class GouiDeviceInfo : DeviceInfo
        {
        ...
        class GouiPlatformServices : IPlatformServices
        {
            public bool IsInvokeRequired => false;

            public string RuntimePlatform => "Goui";
            ...
            {
                return new GouiTicker ();
            }

            class GouiTicker : Ticker
            {
                Timer timer;
                ...
                protected override void EnableTimer ()
                {
                    if (timer != null)
                        return;
                    var interval = TimeSpan.FromSeconds (1.0 / Goui.UI.MaxFps);
                    timer = new Timer ((_ => {
                        this.SendSignals ();
                    }), null, (int)interval.TotalMilliseconds, (int)interval.TotalMilliseconds);
                }
        ...
        public class ViewInitializedEventArgs
        {
            ...
            public Goui.Html.Element NativeView { get; set; }
        }
        ...
        public static void LoadApplication (Application application)
        {
            ...
            if (mainPage != null) {
                UI.Publish ("/", application.MainPage.GetGouiElement ());
            }
        }
    }
}
