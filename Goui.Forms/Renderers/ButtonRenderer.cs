...
{
    public class ButtonRenderer : ViewRenderer<Xamarin.Forms.Button, Goui.Html.Button>
    {
        Goui.Color _buttonTextColorDefaultDisabled;
        Goui.Color _buttonTextColorDefaultHighlighted;
        Goui.Color _buttonTextColorDefaultNormal;
        ...
        void UpdateBorder ()
        {
            ...
            if (button.BorderColor != Xamarin.Forms.Color.Default)
                uiButton.Style.BorderColor = button.BorderColor.ToGouiColor (GouiTheme.ButtonBorderColor);
            else
        ...
        {
            Control.Style.Color = Element.TextColor.ToGouiColor (GouiTheme.ButtonTextColor);
        }
    }
}
