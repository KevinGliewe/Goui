...
namespace Goui.Forms.Renderers
{
    public class EntryRenderer : ViewRenderer<Entry, TextInput>
    {
        ...
        protected override void OnElementChanged (ElementChangedEventArgs<Entry> e)
        {
            ...
            if (Control == null) {
                var textField = new Goui.Html.TextInput ();
        ...
        {
            Control.Style.TextAlign = Element.HorizontalTextAlignment.ToGouiTextAlign ();
        }

        void UpdateColor ()
        {
            Control.Style.Color = Element.TextColor.ToGouiColor (GouiTheme.TextColor);
        }
