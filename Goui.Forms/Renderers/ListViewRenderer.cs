...
namespace Goui.Forms.Renderers
{
    public class ListViewRenderer : ViewRenderer<ListView, List>
    {
        ...
        void ListView_ScrollToRequested (object sender, ScrollToRequestedEventArgs e)
        {
            ...
            switch (e.Position) {
                case ScrollToPosition.Start:
                    Control.Send (Goui.Message.Set (Control.Id, "scrollTop", 0));
                    break;
                case ScrollToPosition.End:
                    Control.Send (Goui.Message.Set (Control.Id, "scrollTop", new Goui.Message.PropertyReference { TargetId = Control.Id, Key = "scrollHeight" }));
                    break;
            }
        }
        ...
        void UpdateBackgroundColor ()
        {
            ...
            var backgroundColor = Element.BackgroundColor.ToGouiColor (Xamarin.Forms.Color.White);
