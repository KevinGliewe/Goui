...
namespace Goui.Forms.Renderers
{
    public class LinkLabelRenderer : ViewRenderer<LinkLabel, Anchor>
    {
        ...
        protected override void OnElementChanged (ElementChangedEventArgs<Goui.Forms.LinkLabel> e)
        {
        ...
        protected override void OnElementPropertyChanged (object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Goui.Forms.LinkLabel.HRefProperty.PropertyName)
                UpdateHRef ();
            if (e.PropertyName == Goui.Forms.LinkLabel.TargetProperty.PropertyName)
                UpdateTarget ();
        ...
        {
            Style.BackgroundColor = color.ToGouiColor (Colors.Clear);
        }
        ...
        void UpdateAlignment ()
        {
            ...
            this.Style.TextAlign = Element.HorizontalTextAlignment.ToGouiTextAlign ();
            Control.Style.VerticalAlign = Element.VerticalTextAlignment.ToGouiVerticalAlign ();
        }
        ...
        void UpdateTextColor ()
        {
            ...
            if (textColor.IsDefault) {
                ...
                Control.Style.Color = textColor.ToGouiColor (Xamarin.Forms.Color.Black);
            }
        }
    }
}
