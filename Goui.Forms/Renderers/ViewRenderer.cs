...
{
    public abstract class ViewRenderer : ViewRenderer<View, Goui.Html.Element>
    {
    }

	public class ViewRenderer<TElement, TNativeElement> : VisualElementRenderer<TElement> where TElement : View where TNativeElement : Goui.Html.Element
	{
		...
		protected override void SetBackgroundColor (Xamarin.Forms.Color color)
		{
            ...
            Control.Style.BackgroundColor = color.ToGouiColor (GouiTheme.BackgroundColor);
		}

        protected void SetNativeControl (Goui.Html.Element element)
		{
		...
		protected override void SendVisualElementInitialized (VisualElement element, Goui.Html.Element nativeView)
		{
		...
		void UpdateIsEnabled ()
		{
			...
			var uiControl = Control as Goui.Html.FormControl;
			if (uiControl == null)
				return;
