...
namespace Goui.Forms
{
    public class Platform : BindableObject, IPlatform, INavigation, IDisposable
    {
        ...
        public Goui.Html.Element Element => _renderer;
        ...
        void HandleRendererStyle_PropertyChanged (object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            pageRenderer?.SetElementSize (Goui.Forms.Extensions.ElementExtensions.GetSizeRequest (_renderer, double.PositiveInfinity, double.PositiveInfinity).Request);
        }
