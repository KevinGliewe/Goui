...
namespace Goui.Forms
{
    ...
    public class VisualElementRenderer<TElement> : Goui.Html.Element, IVisualElementRenderer where TElement : VisualElement
    {
        ...
        public Goui.Html.Element NativeView => this;
